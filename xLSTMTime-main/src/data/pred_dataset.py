...
class Dataset_Custom(Dataset):
    def __init__(self, root_path, split='test', size=None,
                 features='M', data_path='C:/Users/mehja/Desktop/zahra/zehra_thesis/codes/cleaned_achen_data_v2.csv',
                 target='AverageTemperature', scale=True, timeenc=0, freq='M',
    ...
    def __read_data__(self):
        ...
        self.data_y = data[border1:border2]
        self.data_stamp = data_stamp
        #print("Complete date range in dataset:", df_raw[self.time_col_name].min(), "to", df_raw[self.time_col_name].max())  
        #print("Train Border:", border1s[0], "to", border2s[0])  
        #print("Validation Border:", border1s[1], "to", border2s[1])  
        #print("Test Border:", border1s[2], "to", border2s[2])  
